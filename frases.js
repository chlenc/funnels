...
module.exports = {
    ...
    'В нем мы рассмотрим разные системы мотивации персонала и остановимся подробно на системе начисления заработной платы таким образом,'+
    ' чтобы каждый сотрудник был заинтересован в росте прибыли компании. "Такое вообще реально?", - спросите Вы. ДА!!! Жмите скорее кнопку '+
    '"Посмотреть видео"! \n'+url,
    ...
    video6: 'Наверняка вы уже начали применять что-то из полученного в своем бизнесе. '+
    'Это очень хорошо, ведь когда все отлажено можно заниматься стратегическими задачами!'+
    'Если заранее предусмотреть финансовые потоки и учесть возможные факторы,'+
    ' то можно делать уверенные шаги вперед и все больше чувствовать определенность!'+
    'Финансовое планирование - это наш основной продукт. Ниже ссылка на его оплату.  \n'+url,
    video5:'Так много всего сразу! Мысли переполняют..\n' +
    'Но это только часть) Хотите больше?\n' +
    'Восьмичасовой интенсив! Будет жарко!\n' +
    'Цена 4500 руб.\n' +
    'Присоединяйтесь!\t\n'+url,
    finish: 'Вы точно уже начали применять что-то из полученного в своем бизнесе! Это очень хорошо, ведь когда все отлажено можно заниматься стратегическими задачами!\n' +
    'Если заранее предусмотреть финансовые потоки и учесть возможные факторы, то можно делать уверенные шаги вперед и все больше чувствовать определенность!\n' +url
